...
import com.example.quanganh.adapter.PagerAdapter;
import com.example.quanganh.model.NhanVien;
import com.example.quanganh.project.AboutApp;
...
public class HomeActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(HomeActivity.this, R.style.Theme_AppCompat_Dialog_Alert);
            builder.setMessage("Bạn muốn thoát khỏi app?");
